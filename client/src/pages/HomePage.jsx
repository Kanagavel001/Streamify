                ...
                return (
                  <div key={user._id} className='card bg-base-200 hover:shadow-lg transition-all duration-300'>
                    <div className='card-body p-5 space-y-4'>
                      ...
                      {/* Action button */}
                      <button onClick={() => sendRequestMutation(user._id)} className={`btn w-full mt-2 ${hasRequestBeenSent ? "btn-disabled" : "btn-primary"}`} disabled={hasRequestBeenSent || isPending}>
                        { hasRequestBeenSent ? (
                          <>
